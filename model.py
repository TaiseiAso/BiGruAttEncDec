...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.gru = nn.GRU(GLOVE_SIZE, HIDDEN_SIZE, LAYER, batch_first=True, dropout=DROPOUT, bidirectional=True)
...
class Decoder(nn.Module):
    def __init__(self, vocab_size):
        ...
        # self.linear = nn.Linear(GLOVE_SIZE, HIDDEN_SIZE)
        # self.dropout = nn.Dropout(DROPOUT)
        self.gru = nn.GRU(GLOVE_SIZE, HIDDEN_SIZE*2, LAYER, batch_first=True, dropout=DROPOUT)
